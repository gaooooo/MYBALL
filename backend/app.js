...
class AppBootHook {
  ...
  async willReady() {
    ...
    //     // await this.app.model.query("INSERT INTO admins (id, name, password, age, avatar, introduction, register_type, created_at, updated_at, role_id) VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 20, 'https://yugasun.com/static/avatar.jpg', 'Fullstack Engineer', 'default', '2020-02-04 09:55:23', '2020-02-04 09:55:23', 1);");
